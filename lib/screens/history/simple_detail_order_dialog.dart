...
class SimpleDetailOrderDialog extends StatefulWidget {
  const SimpleDetailOrderDialog({Key? key}) : super(key: key);

  @override
  State<SimpleDetailOrderDialog> createState() =>
      _SimpleDetailOrderDialogState();
}

class _SimpleDetailOrderDialogState extends State<SimpleDetailOrderDialog> {
            ...
            if (order.data!.containsKey("cell_id"))
              Padding(
                ...
                child: OrderElementWidget(
                    ...
                    text: "cell_number".tr(
                        namedArgs: {"cell": order.data!["cell_id"].toString()}),
                    iconSize: 26,
                    textStyle: AppStyles.bodyText2),
              ),
